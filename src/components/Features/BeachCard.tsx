 ...
 return (
  ...
  <div className='w-80'> 
   <div 
    ...
    className="relative w-full h-[320px] flex flex-col border border-solid border-gray-200 rounded-2xl transition-all duration-500 "
   >
    ...
    <div className="block overflow-hidden h-2/5 rounded-t-2xl"> 
     ...
     <div className="p-4 flex-1 flex flex-col justify-between"> 
       ...
       <p className="text-sm font-normal text-gray-500 transition-all duration-500 leading-5 mb-5 flex-grow"> 
        {beach.description} 
       </p>
       <button 
        onClick={handleCardClick} 
        className="mt-auto bg-[var(--color-primary-600)] hover:bg-[var(--color-primary-800)] shadow-sm rounded-full py-2 px-5 text-xs text-white font-semibold">
         Confira
       </button>
     </div>
    </div>
