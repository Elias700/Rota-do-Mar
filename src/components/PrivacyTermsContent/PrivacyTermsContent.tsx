            ...
            <div>
                <div className="space-y-4 text-lg"> 
                    ...
                    <div className='pt-10'>
                        ...
                        <ul>
                            <li>
                                <strong>Localização interativa:</strong> 
                                veja no mapa onde cada praia está e como chegar.
                            </li>
                            <li>
                                <strong>Condições do dia:</strong> 
                            ...
                            <li>
                                <strong>Curiosidades:</strong> fatos interessantes, cultura local e eventos que tornam Salvador única.
                            </li>
                            <li>
