        ...
        <main>
            <section className='bg-[var(--color-primary-50)]'>
                <div className='max-w-6xl mx-auto px-4 py-10 lg:py-16 flex flex-col lg:flex-row items-center gap-8'>
                    <div className='flex flex-col max-w-2xl lg:w-1/2'> 
                        <h1 
                            className='text-center lg:text-left text-3xl lg:text-5xl 
                            text-[var(--color-primary-600)] font-[var(--font-chamativa)]'
                        >
                            Bem-vindo ao Rota do Mar
                        </h1>
                        
                        <p 
                            className='mt-6 lg:mt-8 lg:mb-0 text-base lg:text-[1.2rem] 
                            text-[var(--color-primary-900)] px-1 lg:px-0'
                        >
                        ...
                        <div className='text-center lg:text-left mt-10'>
                            <button
                                ...
                                >
                                <span
                                    className="absolute w-64 h-0 transition-all duration-300 origin-center 
                                    rotate-45 -translate-x-20 bg-[var(--color-primary-600)] top-1/2 
                                    group-hover:h-64 group-hover:-translate-y-32 ease"
                                >
                                </span>
                                <span
                                    className="relative text-[1.2rem] font-semibold text-[var(--color-primary-50)] 
                                    transition duration-300 group-hover:text-var[var(--color-primary-50)] ease">
                                        Saiba mais
                                </span>
                            </button>
                        </div>
